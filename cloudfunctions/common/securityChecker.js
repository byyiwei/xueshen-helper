...
class SecurityChecker {
   ...
   * @param {string} mediaUrl - 可公网访问的图片URL
   * @param {string} openid - 用户openid
   * @param {string|number} scene - 场景标识或数字值
   * @returns {object}
   */
   ...
   * @param {string} fileID - 云存储文件ID (cloud://xxx)
   * @param {string} openid - 用户openid
   * @param {string|number} scene - 场景标识
   * @returns {object}
   */
   ...
   * @param {string} openid - 用户openid
   * @param {string|number} scene - 场景标识
   * @param {string} bizId - 业务关联ID（如宠物ID、用户ID等）
   * @returns {object}
   */
