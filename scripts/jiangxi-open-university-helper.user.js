...
// @license      MIT
// @updateURL    https://raw.githubusercontent.com/byyiwei/xueshen-helper/main/scripts/jiangxi-open-university-helper.user.js
// @downloadURL  https://raw.githubusercontent.com/byyiwei/xueshen-helper/main/scripts/jiangxi-open-university-helper.user.js
// ==/UserScript==
...
(function () {
    ...
    /* ======================== 持久化存储 ======================== */
    const STORE_KEY = 'jxrtvu-open-settings-v1';
    let store = {
        account: { username: '', token: '', scriptKey: '' },
        tasks: { exam: true, quiz: true, video: true, examAutoSubmit: false },
    ...
    function log(...args) {
        ...
        console.log('%c[江西开放大学助手]', 'color:#4CAF50;font-weight:bold', msg);
        renderLogPanel();
    }

    /* ======================== 学习记录 ======================== */
    const RECORD_KEY = 'jxrtvu-open-records';
    let records = [];
    ...
    function isExamPage() {
        return /examflow_index|examflow|examPaper|examQuestion|exam|test/i.test(location.href)
    ...
    function createPanel() {
        ...
        panelEl.innerHTML = `
            ...
            <div id="olvh-header">
                <span class="title">🎓 江西开放大学-学习助手</span>
