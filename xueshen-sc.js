...
// @antifeature  payment  AI智能答题和第三方题库搜索为付费功能，基础学习功能永久免费
// @tag          自动学习
// @tag          AI答题
// @tag          超星学习通
// @tag          智慧树
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$7, [
          ...
          !showLogin.value ? (vue.openBlock(), vue.createElementBlock("div", {
            ...
            vue.createElementVNode("div", {
              class: "section-title",
              title: "点击展开",
              onClick: (e) => { e.stopPropagation(); showLogin.value = true; }
            }, [
              vue.createTextVNode("🔑 账号登录"),
              vue.createElementVNode("span", { class: "collapse-icon" }, "+")
            ], 8, ["onClick"])
          ])) : vue.createCommentVNode("", true),
          showLogin.value ? (vue.openBlock(), vue.createElementBlock("div", {
            key: "login",
            ...
            vue.createElementVNode("div", {
              class: "section-title",
              title: "点击收起",
              onClick: (e) => { e.stopPropagation(); showLogin.value = false; }
            }, [
              vue.createTextVNode("🔑 账号登录"),
              vue.createElementVNode("span", { class: "collapse-icon" }, "−")
            ], 8, ["onClick"]),
          ...
          vue.createElementVNode("div", {
            ...
            vue.createElementVNode("div", {
              class: "section-title",
              title: "点击展开/收起",
              onClick: (e) => { e.stopPropagation(); showTips.value = !showTips.value; }
            }, [
              vue.createTextVNode("📌 使用提示"),
              vue.createElementVNode("span", { class: "collapse-icon" }, vue.toDisplayString(showTips.value ? "−" : "+"), 1)
            ], 8, ["onClick"])
          ], 8, ["onClick"]),
          ...
          vue.createElementVNode("div", {
            ...
            vue.createElementVNode("div", {
              class: "section-title",
              title: "点击展开/收起",
              onClick: (e) => { e.stopPropagation(); showTutorial.value = !showTutorial.value; }
            }, [
              vue.createTextVNode("📋 使用教程"),
              vue.createElementVNode("span", { class: "collapse-icon" }, vue.toDisplayString(showTutorial.value ? "−" : "+"), 1)
            ], 8, ["onClick"])
          ], 8, ["onClick"]),
